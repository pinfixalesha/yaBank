package ru.yandex.practicum.yaBank.exchangeGeneratorApplicationTest;
...
public class TestSecurityConfig {
    ...
    public KStream<String, String> printingKStream(StreamsBuilder streamsBuilder) {
        var inputStream = streamsBuilder.stream("exchange", Consumed.with(Serdes.String(), Serdes.String() ));
